...
<div class="container mx-auto mt-10">
    <div class="bg-white p-6 rounded shadow">
        ...
        <a href="{{ route('events.images.create', $event) }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Upload Image</a>
        @if(session('success'))
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="border rounded p-2 flex flex-col items-center">
                <img src="{{ asset('storage/' . $image->path) }}" alt="Event Image" class="h-40 object-cover mb-2">
