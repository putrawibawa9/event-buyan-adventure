                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="footer-widget about-company-widget mb-40 wow fadeInUp">
                                ...
                                <div class="footer-content">
                                    ...
                                    <a href="index.php" class="footer-logo"><img src="assets/images/logo/logo-white.png" alt="Site Logo"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="footer-text">
                                <p>Copy@ 2024 <span style="color: #F7921E;">GoWilds</span>, All Right Reserved</p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!--=== Footer Nav ===-->
